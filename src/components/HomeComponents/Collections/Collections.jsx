...
let Collections = () => {
    return <div className={css.outerDiv}>
        ...
        <div className={css.tagLine}>
            <span className={css.desc}>Explore curated lists of top restaurants, cafes, pubs, and bars in Ahmedabad, based on trends</span>
            <span className={css.collectionPlacesTag}>All collections in Ahmedabad <span className={css.rightArrowBox}><img className={css.rightArrow} src={rightArrow} alt="right arrow" /></span></span>
        </div>
