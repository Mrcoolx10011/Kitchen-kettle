...
let PopularPlaces = () => {
    ...
    return <div className={css.outerDiv}>
        <div className={css.title}><span className={css.titleTxt}>Popular localities in and around</span> <span className={css.bld}>Ahmedabad</span></div>
        <div className={css.placesCards}>
            <PlacesCard place="Navrangpura" count="421" link='/#' />
            <PlacesCard place=" Maninagar" count="421" link='/#' />
