...
let Login = ({ setAuth, setLoggedIn }) => {
    ...
    let loginDiv = !otpModal ? <div className={loginCss.outerDiv}>
        <div className={loginCss.modal}>
            ...
            <div className={loginCss.newToZomato}>New to Kitchen Kettle? <div className={loginCss.createAcc} onClick={() => setAuth({ closed: false, login: false, signup: true })}>Create Account</div></div>
        </div>
